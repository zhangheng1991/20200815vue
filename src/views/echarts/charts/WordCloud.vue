<template>
  <div class="PublicBox">
    <EchartsBox :title="title" />
    <WordCloud :id="id" :data="data" :height="height" :ChattTitle="ChattTitle" :textFont="textFont" />
  </div>
</template>
<script>
import WordCloud from "../../../components/echarts/WordCloud/WordCloud";
import EchartsBox from "../../../components/echarts/EchartsBox/EchartsBox";
export default {
  name: "WordClouds",
  components: { EchartsBox, WordCloud },
  data() {
    return {
      title: "词条云",
      id: "WorldCloud2",
